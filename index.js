...
let posts = [
  {
    ...
    imgageURL: `https://picsum.photos/200/100?random=${Math.floor(Math.random()*9999+1)}`,
  },
  {
    username: "Ammar",
    gender: "male",
...
app.post("/posts/new", (req, res) => {
  ...
  posts.unshift({ username, gender, id: uuidv4(), content, imgageURL: `https://picsum.photos/200/100?random=${Math.floor(Math.random()*9999+1)}` });
  res.redirect("/posts");
});
